...
- **Soporte TI e infraestructura:** trabajo con entornos Windows y Linux, atención técnica y continuidad operativa.
- **Ciberseguridad defensiva:** análisis de eventos, revisión de IOC y enfoque de mejora de controles.
- **Auditoría técnica:** ejercicios simulados sobre infraestructura y validación de prácticas de seguridad.
- **Documentación profesional:** uso de Markdown y entregables publicables para GitHub y revisión técnica.
...
- Desarrollar proyectos académicos y técnicos con enfoque demostrable en GitHub.
- Mejorar procesos de soporte, documentación y análisis operativo con evidencia trazable.
